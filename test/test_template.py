...
def test_render_template_with_string():
    ...
    data = {"key1": "value1", "key2": "value2", "nested": {"key3": "value3"}, "list": [1, 2, 3]}
    template_string = """
...
def test_excel_data_rendering():
    ...
    excel_data = {
        "sheet1": "単一セル値",
        "table1": [{"name": "John", "age": 30, "city": "New York"}, {"name": "Jane", "age": 25, "city": "Los Angeles"}],
        "range1": [{"col1": "A1", "col2": "B1"}, {"col1": "A2", "col2": "B2"}],
    }
